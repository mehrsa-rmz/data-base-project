...
<center><titlu_homepage>Stapanii de pisici</titlu_homepage></center>
<br><br>
...
<center><table id="customers">
        ...
        <tbody>
			...
			$sql1 = "SELECT S.nume, S.prenume, S.nr_telefon, S.e_mail, S.oras, S.judet_sector, S.strada, S.nr_strada
					FROM (SELECT * FROM Stapani) as S
					WHERE id_stapan in 
							(SELECT S.id_stapan
							FROM Stapani S, Pacienti P
							WHERE P.specie = 'pisica' and P.id_stapan = S.id_stapan)";
