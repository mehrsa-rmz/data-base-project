...
session_start();
	...
	$query = "select id_stapan from PACIENTI where id_pacient = '$_GET[id_i]' limit 1";
	$result = mysqli_query($con, $query);
	$id_s = mysqli_fetch_assoc($result);
?>
...
<poz_sageata><?php echo "<a href='admin_stapani2.php?id_s=" . $id_s['id_stapan'] . "'>"?><img src="img\sageata.png" alt="sageata"><text_inapoi_la> inapoi la tabelul cu animalele stapanului</text_inapoi_la></a></poz_sageata>
